...
final class SyncBatchesModule implements ModuleInterface
{
    public function name(): string { return 'table-sync_batches'; }
    public function table(): string { return 'sync_batches'; }
    ...
    public static function contractView(): string { return 'vw_sync_batches'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_sync_batches_created', 'idx_sync_batches_status' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_sb_consumer', 'fk_sb_producer' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_sync_batches_created', 'idx_sync_batches_status' ],
            'foreignKeys' => [ 'fk_sb_consumer', 'fk_sb_producer' ],
        ];
    }
}
