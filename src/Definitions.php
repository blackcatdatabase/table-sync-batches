...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'sync_batches'; }
    public static function contractView(): string { return 'vw_sync_batches'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'channel', 'producer_peer_id', 'consumer_peer_id', 'status', 'items_total', 'items_ok', 'items_failed', 'error', 'created_at', 'started_at', 'finished_at' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'producer_peer_id', 'consumer_peer_id', 'items_total', 'items_ok', 'items_failed' ]; }
