...
namespace BlackCat\Database\Packages\SyncBatches;
...
use BlackCat\Database\Packages\SyncBatches\Repository\SyncBatcheRepository as GeneratedRepository;
...
{
  private SyncBatcheRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SyncBatcheRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SyncBatcheRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SyncBatches\Dto\SyncBatcheDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SyncBatches\Dto\SyncBatcheDto|null { return $this->repo->getById($id, $asDto); }
