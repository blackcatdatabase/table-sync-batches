...
use BlackCat\Database\Packages\SyncBatches\Repository\SyncBatcheRepository;
...
{
    private SyncBatcheRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new SyncBatcheRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SyncBatches\Dto\SyncBatcheDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\SyncBatches\Dto\SyncBatcheDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SyncBatches\Dto\SyncBatcheDto|null
    {
